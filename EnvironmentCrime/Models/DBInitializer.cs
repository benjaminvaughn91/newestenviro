        ...
        public static void EnsurePopulated(IServiceProvider services)
        {
            ...
            /*if (!context.Employees.Any())
            {
                context.Employees.AddRange(
                  ...
                  new Employee { EmployeeId = "E901", EmployeeName = "NAMN", RoleTitle = "Investigator", DepartmentId = "D05" },
                  new Employee { EmployeeId = "A003", EmployeeName = "A003", RoleTitle = "Investigator", DepartmentId = "D05" }
                );
                context.SaveChanges();
            }*/
